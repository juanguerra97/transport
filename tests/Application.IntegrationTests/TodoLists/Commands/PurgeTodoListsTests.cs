...
using seminario.Application.Common.Security;
using seminario.Application.TodoLists.Commands.CreateTodoList;
using seminario.Application.TodoLists.Commands.PurgeTodoLists;
using seminario.Domain.Entities;
using FluentAssertions;
using NUnit.Framework;

namespace seminario.Application.IntegrationTests.TodoLists.Commands;
